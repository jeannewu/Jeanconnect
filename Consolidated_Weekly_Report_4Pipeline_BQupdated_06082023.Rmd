...
var.list <- unique(c("d_512820379",rfact_ls,bio.col,clc.bldtm,clc.urinetm,incentive.vars,modules,recruit.times,ref.wd,
...
veri_resp <- data[which(data$d_821247024 == 197316935 ),time.list] %>%
  mutate(verified_time = ymd_hms(d_914594314),
         recru_time = ymd_hms(ifelse(veri_resp$d_471593703 =="NA",veri_resp$d_914594314, veri_resp$d_471593703)),
