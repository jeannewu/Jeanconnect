...
knit: (function(inputFile, encoding) {rmarkdown::render("~/Documents/GitHub/Jeanconnect/Consolidated_Weekly_Report_4Pipeline_BQupdated_06082023.Rmd", output_file=paste("~/Documents/GitHub/Jeanconnect/Connect_WeeklyOperationsMetrics_", Sys.Date()-1, ".pdf", sep=""))})
...
This report contains data as of `r format(Sys.Date()-1, '%d %B, %Y')`. Atypical records under investigation are not included in the metrics tables and may result in Total columns that do not add up to 100%
...
for (i in 1: length(cnames)){
   ...
   #  saveRDS(recr_signin1,paste("~/Documents/CONNECT_projects/Biospecimen_Feb2022/Jing_projects/biospecQC_03082022/data/recruit_signin",currentDate,".rds", sep=""))
   #recr_signin1 <- readRDS("~/Documents/CONNECT_projects/Biospecimen_Feb2022/Jing_projects/biospecQC_03082022/data/recruit_signin2023-07-31.rds" )
...
activrecruit.n <- table43_Totalactivecamp[["table_body"]][c(2:11), c("label","stat_0")]
...
#data$active_camptype <- factor(data$active_camptype,levels=c("Random","Screening appointment","Non-screening appointment","Demographic Group","Aging out of study","Geographic group","Post-Screening Selection","Technology adapters","Low-income/health professional shortage areas","Other","None of these apply","NA/Unknown"))

#data$active_camptype <- droplevels(data$active_camptype)
table43$active_camptype <- factor(table43$active_camptype, levels=c("Aging out of study","Demographic Group", "Geographic group","Non-screening appointment", "None of these apply", "Random","Screening appointment", "Post-screening appointment", "Technology adapters",  "Low-income/health professional shortage areas", "Other", "NA/Unknown"))
table43$active_camptype <- droplevels(table43$active_camptype)
...
veri_act$allacts.week1 <- ceiling(as.numeric(difftime(as_date(as.POSIXct(veri_act$allacts.time1)+days(5)),as_date(recrstart.date), units="days"))/7)
